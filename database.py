...
class myDB:
    ...
    def addPokemon(self, key: str, inputDictionary: dict) -> bool:
        # preprocessing
        try:
    ...
    def updatePoke(self, userKey: str, attributes: dict) -> bool:
        try:
    ...
    def deletePokemon(self, userKey: str, inputDict: dict) -> bool:
        print(inputDict)
        try:
